...
os.environ['MLFLOW_TRACKING_URI'] = "https://dagshub.com/siddhant.jain18/MLops-pipeline.mlflow"
os.environ['MLFLOW_TRACKING_USERNAME'] = "siddhant.jain18"
os.environ['MLFLOW_TRACKING_PASSWORD'] = "a6b9210e13d8c3e5c144b44f5270564f1fde52e5"
...
params = yaml.safe(open("params.yaml"))['train']
...
def train(data_path, model_path, random_state, n_estimators, max_depth):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/siddhant.jain18/MLops-pipeline.mlflow")
